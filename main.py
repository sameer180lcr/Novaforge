...
CATALOG = [
    ...
    },
    {
        ...
        "image": "https://images.unsplash.com/photo-1506089676908-3592f7389d4d?w=800&q=80&auto=format&fit=crop",
    ...
    },
    {
        ...
        "image": "https://images.unsplash.com/photo-1526948128573-703ee1aeb6fa?w=800&q=80&auto=format&fit=crop",
...
def products():
    ...
    items = [p for p in CATALOG if (p["type"] == f)] if f else CATALOG
    return render_template("products.html", products=items, active_filter=f)
...
def contact():
    if request.method == "POST":
        # In production, send email or create a support ticket
        data = {
